...
MC <- as.numeric(unlist(subset(data, select = c("counts_it1000000"))))
col <- as.numeric(unlist(subset(data, select = c("noisy_counts_it10000000"))))
err_MC = abs((MC) - theo)/theo*100
