...
dataframe = pd.DataFrame(columns=["files", "particle_positions_x", "particle_positions_y", "particle_positions_z",
                                  "distance_face_detector", "counts_cpp", "counts_python", "abs_error", "rel_error"])
